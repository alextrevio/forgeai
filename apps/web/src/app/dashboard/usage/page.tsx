...
export default function UsagePage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#0A0A0A]">
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-40 flex h-screen flex-col border-r border-[#2A2A2A] bg-[#111111] transition-all duration-300",
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative w-full flex justify-center flex-1">
                      <div className="w-full max-w-[48px] rounded-t-lg bg-[#1A1A1A] relative overflow-hidden self-end"
                        style={{ height: "100%" }}
                      >
                        <div
                        ...
                        >
                          <button
                            ...
                            className={cn(
                              ...
                              isCurrent
                                ? "bg-[#1A1A1A] text-gray-400 cursor-default"
                                : plan.highlight
                                  ? "bg-[#6d5cff] text-white hover:bg-[#6d5cff]/90 shadow-lg shadow-[#6d5cff]/20"
                                  : "border border-[#2A2A2A] text-white hover:bg-[#1A1A1A] hover:border-[#6d5cff]/50",
