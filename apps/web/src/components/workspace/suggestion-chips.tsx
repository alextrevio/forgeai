    ...
    <div className="flex flex-wrap gap-1.5 px-4 py-2 border-t border-border/30">
      {chips.map((chip) => (
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-full border border-border bg-[#111111] px-2.5 py-1 text-[11px] text-[#888888] hover:text-[#EDEDED] hover:border-[#7c3aed]/30 hover:bg-[#7c3aed]/5 transition-all duration-150 hover:scale-[1.02] cursor-pointer"
        >
